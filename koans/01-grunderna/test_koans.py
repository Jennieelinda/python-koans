...
def test_integers_and_floats_have_different_types():
    ...
    assert (type(42) == type(42.0)) == ___False_
...
def test_none_has_its_own_dedicated_type():
    ...
    Vad heter typen?"""
    assert type(None).__name__ == ___"NoneType"_
...
def test_bool_is_a_subclass_of_int():
    ...
    assert isinstance(True, int) == True____
